 ...
 *******************************************************************************
 */
package ohos.global.icu.dev.test.rbbi;
...
public class BreakIteratorTest extends TestFmwk
{
    ...
    public void TestGetAvailableLocales()
    {
        ...
        ohos.global.icu.util.ULocale[] ulocList = BreakIterator.getAvailableULocales();
    ...
    public void TestT5615() {
        ohos.global.icu.util.ULocale[] ulocales = BreakIterator.getAvailableULocales();
        int type = 0;
        ohos.global.icu.util.ULocale loc = null;
        try {
