...
public class CalendarRegressionTest extends ohos.global.icu.dev.test.TestFmwk {
  ...
  //      }
    ...
    // Re-enabled after 'porting' TZ and STZ from java.util to ohos.global.icu.util.
    /**
    ...
    public void TestSerialization3474() {
        try {
            ...
            ohos.global.icu.util.GregorianCalendar icuCalendar =
                new ohos.global.icu.util.GregorianCalendar();
            ...
            icuCalendar.set(ohos.global.icu.util.GregorianCalendar.SECOND, 0);
            ...
            icuCalendar = null;
            icuCalendar = (ohos.global.icu.util.GregorianCalendar)icuIn.readObject();
