...
public class NamePrepTransform {
    ...
    private NamePrepTransform(){
        ...
        ICUResourceBundle bundle = (ICUResourceBundle)ICUResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata","idna_rules", NamePrepTransform.class.getClassLoader(), true);
    ...
    */
    ...
    private static class MapTransform {
        ...
        boolean initialize(String id, String rule, int direction) {
            try {
                Class cls = Class.forName("ohos.global.icu.text.Transliterator");
