 ...
 *******************************************************************************
 */
package ohos.global.icu.dev.test.lang;
...
import ohos.global.icu.dev.util.CollectionUtilities;
import ohos.global.icu.impl.SortedSetRelation;
import ohos.global.icu.impl.Utility;
import ohos.global.icu.lang.UCharacter;
import ohos.global.icu.lang.UCharacterEnums.ECharacterCategory;
...
import ohos.global.icu.text.UnicodeSet.ComparisonStyle;
import ohos.global.icu.text.UnicodeSet.EntryRange;
import ohos.global.icu.text.UnicodeSet.SpanCondition;
import ohos.global.icu.text.UnicodeSetIterator;
import ohos.global.icu.text.UnicodeSetSpanner;
import ohos.global.icu.text.UnicodeSetSpanner.CountMethod;
import ohos.global.icu.text.UnicodeSetSpanner.TrimOption;
...
public class UnicodeSetTest extends TestFmwk {
    ...
    public class TokenSymbolTable implements SymbolTable {
        ...
        /* (non-Javadoc)
         * @see ohos.global.icu.text.SymbolTable#lookup(java.lang.String)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see ohos.global.icu.text.SymbolTable#lookupMatcher(int)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see ohos.global.icu.text.SymbolTable#parseReference(java.lang.String,
     java.text.ParsePosition, int)
        ...
        public String parseReference(String text, ParsePosition pos, int
            ...
            for (i = start; i < limit; i += UTF16.getCharCount(cp)) {
                ...
                if (!ohos.global.icu.lang.UCharacter.isUnicodeIdentifierPart(cp)) {
                    break;
                }
            }
