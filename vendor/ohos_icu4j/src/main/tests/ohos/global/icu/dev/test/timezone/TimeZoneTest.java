...
package ohos.global.icu.dev.test.timezone;
...
//    /"DateFormatZoneData",
    ...
    public void TestFractionalDST() {
        ...
        ohos.global.icu.util.TimeZone tz_icu = ohos.global.icu.util.TimeZone.getTimeZone(tzName);
    ...
    public void TestZoneMeta() {
        ...
        ohos.global.icu.util.TimeZone.setDefault(null);
        java.util.TimeZone.setDefault(newZone);
        SimpleTimeZone zone = new SimpleTimeZone(0, "GMT");
        ohos.global.icu.util.TimeZone defaultZone = ohos.global.icu.util.TimeZone.getDefault();
        if(defaultZone==null){
        ...
        for (int i = 0; i < ids.length; i++) {
            ...
            for (int j = 0; j < nEquiv; j++) {
                ...
                if (j == 0) {
                    ...
                    if (tmpCanonical.equals("Australia/Hobart") && canonicalID.equals("Australia/Currie")) {
                        continue;
                    }
