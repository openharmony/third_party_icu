 ...
 *******************************************************************************
 */
package ohos.global.icu.dev.test.translit;
...
import ohos.global.icu.impl.UtilityExtensions;
...
import ohos.global.icu.text.UnicodeFilter;
...
3. The tests in this file exactly match those in a sister file on the
   ...
   icu4j:  src/ohos.global.icu.dev.test/translit/TransliteratorTest.java
...
public class TransliteratorTest extends TestFmwk {
    ...
    public void TestNormalizationTransliterator() {
        // THE FOLLOWING TWO TABLES ARE COPIED FROM ohos.global.icu.dev.test.normalizer.BasicTest
    ...
    public void TestSpecialCases() {
        ...
        for (int i = 0; i < testCases.length; ++i) {
            ...
            else if (id.equalsIgnoreCase("NFD"))    target = ohos.global.icu.text.Normalizer.normalize(source, ohos.global.icu.text.Normalizer.NFD);
            else if (id.equalsIgnoreCase("NFC"))    target = ohos.global.icu.text.Normalizer.normalize(source, ohos.global.icu.text.Normalizer.NFC);
            else if (id.equalsIgnoreCase("NFKD"))   target = ohos.global.icu.text.Normalizer.normalize(source, ohos.global.icu.text.Normalizer.NFKD);
            else if (id.equalsIgnoreCase("NFKC"))   target = ohos.global.icu.text.Normalizer.normalize(source, ohos.global.icu.text.Normalizer.NFKC);
