...
public final class ICUResourceBundleTest extends TestFmwk {
    ...
    public void TestGetResources(){
        try{
            ...
            Enumeration en = testLoader.getResources("ohos.global.icu.dev.data");
    ...
    public void TestResourceBundleWrapper(){
        UResourceBundle bundle = UResourceBundle.getBundleInstance("ohos.global.icu.impl.data.HolidayBundle", "da_DK");
    ...
    public void TestJB3879(){
        ...
        try {
            UResourceBundle bundle = UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata", ULocale.getDefault(), testLoader);
            if(bundle==null){
    ...
    public void TestBasicTypes(){
        ...
        try {
            bundle = UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata", "testtypes", testLoader);
        }
    ...
    public void TestTable32(){
        ...
        UResourceBundle bundle = null;
        try {
            bundle = UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata","testtable32", testLoader);
        }
        catch (MissingResourceException ex) {
    ...
    public void TestAliases(){
       ...
       UResourceBundle rb = UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata","testaliases", testLoader);
       if (rb == null) {
        ...
        {
            try{
                rb = UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata","testaliases",testLoader);
        ...
        {
            UResourceBundle rb1 = UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata","testaliases",testLoader);
            if(rb1!=rb){
...
//        }
        ...
        // Test case for #7996
        {
            UResourceBundle bundle = UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata", "te", testLoader);
    ...
    public void TestXPathAlias(){
        UResourceBundle rb = UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata","te_IN",testLoader);
    ...
    public void TestPreventFallback() {
        ...
        ICUResourceBundle rb = (ICUResourceBundle) UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata","te_IN_NE",testLoader);
        try {
        ...
        rb = (ICUResourceBundle) UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata","te",testLoader);
        rb.getStringWithFallback(noFallbackResource);
    }
...
//          }
    ...
    public void TestCLDRStyleAliases() {
        ...
        UResourceBundle rb = UResourceBundle.getBundleInstance("ohos/global/icu/dev/data/testdata", "te_IN_REVISED", testLoader);
    ...
    public void TestJavaULocaleBundleLoading(){
        String baseName="ohos.global.icu.dev.data.resources.TestDataElements";
    ...
    public void TestICUGetKeysAtTopLevel() {
        String baseName="ohos/global/icu/dev/data/testdata";
    ...
    public void TestT6844() {
        try {
            UResourceBundle rb1
                = UResourceBundle.getBundleInstance("ohos.global.icu.dev.data.resources.TestMessages", ULocale.getDefault(), testLoader);
    ...
    public void TestUResourceBundleCoverage() {
        ...
        rb7 = UResourceBundle.getBundleInstance("ohos.global.icu.dev.data.resources.TestDataElements", Locale.getDefault(), testLoader);
