...
import ohos.global.icu.util.IslamicCalendar;
import ohos.global.icu.util.JapaneseCalendar;
...
public class DateFormatRegressionTest extends TestFmwk {
    ...
    public void Test5006GetShortMonths() throws Exception {
        ...
        for (int i = 0; i < locales.length; i++) {
            ...
            // Islamic
            ohos.global.icu.util.Calendar islamicCivilCalendar = new ohos.global.icu.util.IslamicCalendar(locale);
            ohos.global.icu.text.SimpleDateFormat islamicCivilDateFormat = (ohos.global.icu.text.SimpleDateFormat) islamicCivilCalendar
                    .getDateTimeFormat(ohos.global.icu.text.DateFormat.FULL, -1, locale);
            ohos.global.icu.text.DateFormatSymbols islamicCivilDateFormatSymbols = islamicCivilDateFormat
            ...
            ohos.global.icu.util.IslamicCalendar islamicCalendar = new ohos.global.icu.util.IslamicCalendar(locale);
            islamicCalendar.setCivil(false);
            ohos.global.icu.text.SimpleDateFormat islamicDateFormat = (ohos.global.icu.text.SimpleDateFormat) islamicCalendar
                    .getDateTimeFormat(ohos.global.icu.text.DateFormat.FULL, -1, locale);
            ohos.global.icu.text.DateFormatSymbols islamicDateFormatSymbols = islamicDateFormat
                    .getDateFormatSymbols();
            ...
            // Gregorian
            ohos.global.icu.util.Calendar gregorianCalendar = new ohos.global.icu.util.GregorianCalendar(
                    locale);
            ohos.global.icu.text.SimpleDateFormat gregorianDateFormat = (ohos.global.icu.text.SimpleDateFormat) gregorianCalendar
                    .getDateTimeFormat(ohos.global.icu.text.DateFormat.FULL, -1, locale);

            ohos.global.icu.text.DateFormatSymbols gregorianDateFormatSymbols = gregorianDateFormat
                    .getDateFormatSymbols();
