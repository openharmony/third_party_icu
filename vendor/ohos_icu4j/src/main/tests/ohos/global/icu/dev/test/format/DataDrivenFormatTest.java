...
import ohos.global.icu.dev.test.ModuleTest;
import ohos.global.icu.dev.test.ModuleTest.TestDataPair;
import ohos.global.icu.dev.test.TestDataModule;
import ohos.global.icu.dev.test.TestDataModule.DataMap;
import ohos.global.icu.dev.test.TestDataModule.TestData;
import ohos.global.icu.dev.test.TestFmwk;
import ohos.global.icu.dev.test.util.CalendarFieldsSet;
import ohos.global.icu.dev.test.util.DateTimeStyleSet;
...
public class DataDrivenFormatTest extends TestFmwk {
    ...
    private List<TestDataPair> getTestData() throws Exception { 
        return ModuleTest.getTestData("ohos/global/icu/dev/data/testdata/", "format");
    }

    /* (non-Javadoc)
     * @see ohos.global.icu.dev.test.ModuleTest#processModules()
     */
    @Test
