 ...
 *******************************************************************************
*/
package ohos.global.icu.dev.test.stringprep;
...
public final class NFS4StringPrep {
    ...
    private  NFS4StringPrep (){
        ...
        try{
            InputStream  nfscsiFile = loader.getResourceAsStream("ohos/global/icu/dev/data/testdata/nfscsi.spp");
            nfscsi = new StringPrep(nfscsiFile);
            nfscsiFile.close();
            
            InputStream  nfscssFile = loader.getResourceAsStream("ohos/global/icu/dev/data/testdata/nfscss.spp");
            nfscss = new StringPrep(nfscssFile);
            nfscssFile.close();
            
            InputStream  nfscisFile = loader.getResourceAsStream("ohos/global/icu/dev/data/testdata/nfscis.spp");
            nfscis = new StringPrep(nfscisFile);
            nfscisFile.close();
            
            InputStream  nfsmxpFile = loader.getResourceAsStream("ohos/global/icu/dev/data/testdata/nfsmxp.spp");
            nfsmxp = new StringPrep(nfsmxpFile);
            nfsmxpFile.close();
            
            InputStream  nfsmxsFile = loader.getResourceAsStream("ohos/global/icu/dev/data/testdata/nfsmxs.spp");
