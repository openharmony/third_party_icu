...
import ohos.global.icu.util.StringTokenizer;
...
public final class StringTokenizerTest extends TestFmwk
{
    ...
    public void TestNoCoalesce() {
        ...
        ohos.global.icu.util.StringTokenizer it = new ohos.global.icu.util.StringTokenizer(str, delims, true);
        int n = 0;
        ...
        it = new ohos.global.icu.util.StringTokenizer(sur, delims, true); // no coalesce
