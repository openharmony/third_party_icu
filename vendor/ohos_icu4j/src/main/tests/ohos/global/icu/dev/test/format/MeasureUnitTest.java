...
import ohos.global.icu.dev.test.serializable.FormatHandler;
...
public class MeasureUnitTest extends TestFmwk {
    ...
    public void testCLDRUnitAvailability() {
        ...
        try {
            cMeasureUnit = Class.forName("ohos.global.icu.util.MeasureUnit");
            cTimeUnit = Class.forName("ohos.global.icu.util.TimeUnit");
