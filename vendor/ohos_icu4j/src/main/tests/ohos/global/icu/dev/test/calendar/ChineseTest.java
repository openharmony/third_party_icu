...
//        }
    ...
    public void Test6510()
    {
        ...
        simpleDateFormat = new ohos.global.icu.text.SimpleDateFormat("MM/dd/yyyy G 'at' HH:mm:ss vvvv", Locale.US);
        dateFormat = new ohos.global.icu.text.ChineseDateFormat("MM/dd/yyyy(G) HH:mm:ss", Locale.CHINA);
