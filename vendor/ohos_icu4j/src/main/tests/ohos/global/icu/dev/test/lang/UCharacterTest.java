...
import ohos.global.icu.lang.UCharacterCategory;
...
public final class UCharacterTest extends TestFmwk
{
    ...
    * ohos.global.icu.dev.test.lang.UCharacterTest
    */
    @Test
                ...
                for (int i = 0; i < defaultBidi.length && c < result.limit;
                    ...
                    if (c < defaultBidi[i][0]) {
                        while (c < result.limit && c < defaultBidi[i][0]) {
                            ...
                            if(ohos.global.icu.impl.UCharacterUtility.isNonCharacter(c) || UCharacter.hasBinaryProperty(c, UProperty.DEFAULT_IGNORABLE_CODE_POINT)) {
