...
import ohos.global.icu.dev.test.serializable.SerializableTestUtility.Handler;
...
public class CompatibilityTest extends TestFmwk
{
     ...
     */
    private static final String ACTUAL_RESOURCE = "/ICU_3.6/ohos.global.icu.impl.OlsonTimeZone.dat";
    ...
    private static final String[][] SKIP_CASES = {
            ...
            {"ICU_50.1", "ohos.global.icu.text.CurrencyPluralInfo"},
            {"ICU_51.1", "ohos.global.icu.text.CurrencyPluralInfo"},

            {"ICU_50.1", "ohos.global.icu.text.PluralFormat"},
            {"ICU_51.1", "ohos.global.icu.text.PluralFormat"},

            {"ICU_50.1", "ohos.global.icu.text.PluralRules"},
            {"ICU_51.1", "ohos.global.icu.text.PluralRules"},

            // GeneralMeasureFormat was in technical preview, but is going away after ICU 52.1.
            {"ICU_52.1", "ohos.global.icu.text.GeneralMeasureFormat"},

            // RuleBasedNumberFormat
            {"ICU_3.6",     "ohos.global.icu.text.RuleBasedNumberFormat"},

            // ICU 4.8+ MessageFormat is not serialization-compatible with previous versions.
            {"ICU_3.6",     "ohos.global.icu.text.MessageFormat"},
    };
}
