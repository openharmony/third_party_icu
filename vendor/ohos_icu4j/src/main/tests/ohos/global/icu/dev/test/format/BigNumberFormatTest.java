...
public class BigNumberFormatTest extends TestFmwk {
    ...
    public void TestAlphaBigDecimal() {
        ...
        expect(NumberFormat.getScientificInstance(Locale.US),
               new Number[] { new ohos.global.icu.math.BigDecimal("12345.678901"),
                           },
               "1.2345678901E4");
        expect(new DecimalFormat("##0.####E0", US),
               new Number[] { new ohos.global.icu.math.BigDecimal("12345.4999"),
                              new ohos.global.icu.math.BigDecimal("12344.5001"),
                            },
               "12.345E3");
        expect(new DecimalFormat("##0.####E0", US),
               new Number[] { new ohos.global.icu.math.BigDecimal("12345.5000"),
                              new ohos.global.icu.math.BigDecimal("12346.5000"),
                            },
               "12.346E3");
    }
    ...
    private static String showNumber(Number n) {
        ...
        if (!(n instanceof ohos.global.icu.math.BigDecimal
    ...
    public void TestBigDecimalJ28() {
        ...
        for (int i=0; i<DATA.length; i+=2) {
            String input = DATA[i];
            String exp = DATA[i+1];
            ohos.global.icu.math.BigDecimal bd = new ohos.global.icu.math.BigDecimal(input);
    ...
    public void TestBigDecimalRounding() {
        ...
        ohos.global.icu.text.DecimalFormat icuFormat=new ohos.global.icu.text.DecimalFormat("###,###,###,##0");
        String[] values = {
