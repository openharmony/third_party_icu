...
/**
 * JavaTimeZone inherits ohos.global.icu.util.TimeZone and wraps java.util.TimeZone.
...
public class JavaTimeZone extends TimeZone {
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#getOffset(int, int, int, int, int, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#getOffset(long, boolean, int[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#getRawOffset()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#inDaylightTime(java.util.Date)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#setRawOffset(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#useDaylightTime()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#observesDaylightTime()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#getDSTSavings()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#clone()
     */
    @Override
    public Object clone() {
        if (isFrozen()) {
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#hashCode()
     */
    @Override
    public int hashCode() {
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#isFrozen()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#freeze()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.util.TimeZone#cloneAsThawed()
     */
    @Override
