...
public final class UScript {
    ...
    private static int[] getCodesFromLocale(ULocale locale) {
        ...
        if(script.length() != 0) {
            if (lang.equals("en") && script.equals("Qaag")) {
                return new int[] { UScript.LATIN };
            }
            // In Burmese, the script is Zawgyi
            if (lang.equals("my") && script.equals("Qaag")) {
                return new int[] { UScript.MYANMAR };
            }
