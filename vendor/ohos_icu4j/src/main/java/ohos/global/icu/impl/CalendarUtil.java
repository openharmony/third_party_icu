 ...
 * Calendar utilities.
 *
 * Date/time format service classes in ohos.global.icu.text packages
 * sometimes need to access calendar internal APIs.  But calendar
 * classes are in ohos.global.icu.util package, so the package local
 * cannot be used.  This class is added in ohos.global.icu.impl
