...
class CaseFoldTransliterator extends Transliterator{
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.Transliterator#addSourceTargetSet(ohos.global.icu.text.UnicodeSet, ohos.global.icu.text.UnicodeSet, ohos.global.icu.text.UnicodeSet)
     */
    @Override
