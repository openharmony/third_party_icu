...
import ohos.global.icu.impl.TextTrieMap.ResultHandler;
import ohos.global.icu.text.TimeZoneNames;
import ohos.global.icu.util.TimeZone;
import ohos.global.icu.util.TimeZone.SystemTimeZoneType;
...
public class TimeZoneNamesImpl extends TimeZoneNames {
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.TimeZoneNames#getAvailableMetaZoneIDs()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.TimeZoneNames#getAvailableMetaZoneIDs(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.TimeZoneNames#getMetaZoneID(java.lang.String, long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.TimeZoneNames#getReferenceZoneID(java.lang.String, java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ohos.global.icu.text.TimeZoneNames#getMetaZoneDisplayName(java.lang.String, ohos.global.icu.text.TimeZoneNames.NameType)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ohos.global.icu.text.TimeZoneNames#getTimeZoneDisplayName(java.lang.String, ohos.global.icu.text.TimeZoneNames.NameType)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.TimeZoneNames#getExemplarLocationName(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.TimeZoneNames#find(java.lang.CharSequence, int, java.util.Set)
     */
    @Override
    ...
    private static class NameSearchHandler implements ResultHandler<NameInfo> {
        ...
        /* (non-Javadoc)
         * @see ohos.global.icu.impl.TextTrieMap.ResultHandler#handlePrefixMatch(int, java.util.Iterator)
         */
        @Override
    ...
    private static class TZ2MZsCache extends SoftCache<String, List<MZMapEntry>, String> {
        /* (non-Javadoc)
         * @see ohos.global.icu.impl.CacheBase#createInstance(java.lang.Object, java.lang.Object)
         */
        @Override
