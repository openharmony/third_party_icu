...
/* 1998.10.12 change package to ohos.global.icu.math                          */
...
public class BigDecimal extends java.lang.Number implements java.io.Serializable, java.lang.Comparable<BigDecimal> {
     ...
     * @see #TEN
     */
    public static final ohos.global.icu.math.BigDecimal ZERO = new ohos.global.icu.math.BigDecimal((long) 0); // use long as we
                                                                                                      // want the int
                                                                                                      // constructor
     ...
     * @see #ZERO
     */
    public static final ohos.global.icu.math.BigDecimal ONE = new ohos.global.icu.math.BigDecimal((long) 1); // use long as we
                                                                                                     // want the int
                                                                                                     // constructor
    // .. to be able to use this, for speed
     ...
     * @see #ZERO
     */
    public static final ohos.global.icu.math.BigDecimal TEN = new ohos.global.icu.math.BigDecimal(10);
     ...
     */
    public static final int ROUND_CEILING = ohos.global.icu.math.MathContext.ROUND_CEILING;
     ...
     */
    public static final int ROUND_DOWN = ohos.global.icu.math.MathContext.ROUND_DOWN;
     ...
     */
    public static final int ROUND_FLOOR = ohos.global.icu.math.MathContext.ROUND_FLOOR;
     ...
     */
    public static final int ROUND_HALF_DOWN = ohos.global.icu.math.MathContext.ROUND_HALF_DOWN;
     ...
     */
    public static final int ROUND_HALF_EVEN = ohos.global.icu.math.MathContext.ROUND_HALF_EVEN;
     ...
     */
    public static final int ROUND_HALF_UP = ohos.global.icu.math.MathContext.ROUND_HALF_UP;
     ...
     */
    public static final int ROUND_UNNECESSARY = ohos.global.icu.math.MathContext.ROUND_UNNECESSARY;
     ...
     */
    public static final int ROUND_UP = ohos.global.icu.math.MathContext.ROUND_UP;
    ...
    private static final ohos.global.icu.math.MathContext plainMC = new ohos.global.icu.math.MathContext(0,
            ohos.global.icu.math.MathContext.PLAIN); // context for plain unlimited math
     ...
     * @serial
     */
    private byte form = (byte) ohos.global.icu.math.MathContext.PLAIN; // assumed PLAIN
     ...
     * <p>
     * <i>(Note: this constructor is provided only in the <code>ohos.global.icu.math</code> version of the BigDecimal class.
    ...
    public BigDecimal(char inchars[], int offset, int length) {
        ...
        if (mant[0] == 0) {
            ...
            // now determine form
            if (hadexp) {
                form = (byte) ohos.global.icu.math.MathContext.SCIENTIFIC;
    ...
    public ohos.global.icu.math.BigDecimal abs() {
    ...
    public ohos.global.icu.math.BigDecimal abs(ohos.global.icu.math.MathContext set) {
        if (this.ind == isneg)
    ...
    public ohos.global.icu.math.BigDecimal add(ohos.global.icu.math.BigDecimal rhs) {
    ...
    public ohos.global.icu.math.BigDecimal add(ohos.global.icu.math.BigDecimal rhs, ohos.global.icu.math.MathContext set) {
        ohos.global.icu.math.BigDecimal lhs;
        int reqdig;
        ohos.global.icu.math.BigDecimal res;
        byte usel[];
        int usellen;
        byte user[];
        int userlen;
        ...
        if (lhs.ind == 0)
            if (set.form != ohos.global.icu.math.MathContext.PLAIN)
                return rhs.plus(set);
        if (rhs.ind == 0)
            if (set.form != ohos.global.icu.math.MathContext.PLAIN)
                return lhs.plus(set);
        ...
        res = new ohos.global.icu.math.BigDecimal(); // build result here
    ...
    @Override
    public int compareTo(ohos.global.icu.math.BigDecimal rhs) {
    ...
    public int compareTo(ohos.global.icu.math.BigDecimal rhs, ohos.global.icu.math.MathContext set) {
        int thislength = 0;
        int i = 0;
        ohos.global.icu.math.BigDecimal newrhs;
    ...
    public ohos.global.icu.math.BigDecimal divide(ohos.global.icu.math.BigDecimal rhs) {
    ...
    public ohos.global.icu.math.BigDecimal divide(ohos.global.icu.math.BigDecimal rhs, int round) {
        ohos.global.icu.math.MathContext set;
        set = new ohos.global.icu.math.MathContext(0, ohos.global.icu.math.MathContext.PLAIN, false, round); // [checks round,
                                                                                                     // too]
    ...
    public ohos.global.icu.math.BigDecimal divide(ohos.global.icu.math.BigDecimal rhs, int scale, int round) {
        ohos.global.icu.math.MathContext set;
        if (scale < 0)
    ...
    public ohos.global.icu.math.BigDecimal divide(ohos.global.icu.math.BigDecimal rhs, ohos.global.icu.math.MathContext set) {
    ...
    public ohos.global.icu.math.BigDecimal divideInteger(ohos.global.icu.math.BigDecimal rhs) {
    ...
    public ohos.global.icu.math.BigDecimal divideInteger(ohos.global.icu.math.BigDecimal rhs, ohos.global.icu.math.MathContext set) {
        // scale 0 to drop .000 when plain
    ...
    public ohos.global.icu.math.BigDecimal max(ohos.global.icu.math.BigDecimal rhs) {
    ...
    public ohos.global.icu.math.BigDecimal max(ohos.global.icu.math.BigDecimal rhs, ohos.global.icu.math.MathContext set) {
    ...
    public ohos.global.icu.math.BigDecimal min(ohos.global.icu.math.BigDecimal rhs) {
    ...
    public ohos.global.icu.math.BigDecimal min(ohos.global.icu.math.BigDecimal rhs, ohos.global.icu.math.MathContext set) {
        if ((this.compareTo(rhs, set)) <= 0)
            return this.plus(set);
        else
            return rhs.plus(set);
    ...
    public ohos.global.icu.math.BigDecimal multiply(ohos.global.icu.math.BigDecimal rhs) {
    ...
    public ohos.global.icu.math.BigDecimal multiply(ohos.global.icu.math.BigDecimal rhs, ohos.global.icu.math.MathContext set) {
        ohos.global.icu.math.BigDecimal lhs;
        int padding;
        int reqdig;
        byte multer[] = null;
        ...
        res = new ohos.global.icu.math.BigDecimal(); // where we'll build result
    ...
    public ohos.global.icu.math.BigDecimal negate() {
    ...
    public ohos.global.icu.math.BigDecimal negate(ohos.global.icu.math.MathContext set) {
        ohos.global.icu.math.BigDecimal res;
        // Originally called minus(), changed to matched Java precedents
        // This simply clones, flips the sign, and possibly rounds
        if (set.lostDigits)
            checkdigits((ohos.global.icu.math.BigDecimal) null, set.digits);
    ...
    public ohos.global.icu.math.BigDecimal plus() {
    ...
    public ohos.global.icu.math.BigDecimal plus(ohos.global.icu.math.MathContext set) {
        ...
        if (set.form == ohos.global.icu.math.MathContext.PLAIN)
            if (this.form == ohos.global.icu.math.MathContext.PLAIN) {
    ...
    public ohos.global.icu.math.BigDecimal pow(ohos.global.icu.math.BigDecimal rhs) {
    ...
    public ohos.global.icu.math.BigDecimal pow(ohos.global.icu.math.BigDecimal rhs, ohos.global.icu.math.MathContext set) {
        int n;
        ohos.global.icu.math.BigDecimal lhs;
        int reqdig;
        int workdigits = 0;
        int L = 0;
        ohos.global.icu.math.MathContext workset;
        ohos.global.icu.math.BigDecimal res;
        boolean seenbit;
        int i = 0;
        if (set.lostDigits)
        ...
        workset = new ohos.global.icu.math.MathContext(workdigits, set.form, false, set.roundingMode);
    ...
    public ohos.global.icu.math.BigDecimal remainder(ohos.global.icu.math.BigDecimal rhs) {
    ...
    public ohos.global.icu.math.BigDecimal remainder(ohos.global.icu.math.BigDecimal rhs, ohos.global.icu.math.MathContext set) {
    ...
    public ohos.global.icu.math.BigDecimal subtract(ohos.global.icu.math.BigDecimal rhs) {
    ...
    public ohos.global.icu.math.BigDecimal subtract(ohos.global.icu.math.BigDecimal rhs, ohos.global.icu.math.MathContext set) {
        ohos.global.icu.math.BigDecimal newrhs;
        if (set.lostDigits)
            checkdigits(rhs, set.digits);
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        rhs = (ohos.global.icu.math.BigDecimal) obj; // cast; we know it will work
        if (this.ind != rhs.ind)
    ...
    public java.lang.String format(int before, int after) {
        return format(before, after, -1, -1, ohos.global.icu.math.MathContext.SCIENTIFIC, ROUND_HALF_UP);
    }
    ...
    public java.lang.String format(int before, int after, int explaces, int exdigits, int exformint, int exround) {
        ohos.global.icu.math.BigDecimal num;
        int mag = 0;
        int thisafter = 0;
        int lead = 0;
        byte newmant[] = null;
        ...
        {/* select */
            if (exformint == ohos.global.icu.math.MathContext.SCIENTIFIC) {
            } else if (exformint == ohos.global.icu.math.MathContext.ENGINEERING) {
            } else if (exformint == (-1))
                exformint = ohos.global.icu.math.MathContext.SCIENTIFIC;
        ...
        if (exround != ROUND_HALF_UP) {
            try { // if non-default...
                if (exround == (-1))
                    ...
                    new ohos.global.icu.math.MathContext(9, ohos.global.icu.math.MathContext.SCIENTIFIC, false, exround);
        ...
        /* determine form */
        {
            do {/* select */
                if (exdigits == (-1))
                    num.form = (byte) ohos.global.icu.math.MathContext.PLAIN;
        ...
        if (after >= 0) {
            setafter: for (;;) {
                ...
                {/* select */
                    if (num.form == ohos.global.icu.math.MathContext.PLAIN)
                        thisafter = -num.exp; // has decimal part
                    else if (num.form == ohos.global.icu.math.MathContext.SCIENTIFIC)
    ...
    public ohos.global.icu.math.BigDecimal movePointLeft(int n) {
        ohos.global.icu.math.BigDecimal res;
    ...
    public ohos.global.icu.math.BigDecimal movePointRight(int n) {
        ohos.global.icu.math.BigDecimal res;
        res = clone(this);
        res.exp = res.exp + n;
    ...
    public ohos.global.icu.math.BigDecimal setScale(int scale) {
    ...
    public ohos.global.icu.math.BigDecimal setScale(int scale, int round) {
        int ourscale;
        ohos.global.icu.math.BigDecimal res;
        int padding = 0;
        int newlen = 0;
        ...
        if (ourscale == scale) // already correct scale
            if (this.form == ohos.global.icu.math.MathContext.PLAIN) // .. and form
                return this;
        ...
        res.form = (byte) ohos.global.icu.math.MathContext.PLAIN; // by definition
        return res;
    }
     ...
     * <p>
     * <i>(Note: this method is provided only in the <code>ohos.global.icu.math</code> version of the BigDecimal class. It
    ...
    public java.math.BigInteger toBigInteger() {
        ohos.global.icu.math.BigDecimal res = null;
        int newlen = 0;
        byte newmant[] = null;
        {/* select */
            if ((exp >= 0) & (form == ohos.global.icu.math.MathContext.PLAIN))
                res = this; // can layout simply
            else if (exp >= 0) {
                res = clone(this); // safe copy
                res.form = (byte) ohos.global.icu.math.MathContext.PLAIN; // .. and request PLAIN
            } else {
                { // exp<0; scale to be truncated
                    ...
                    if (-this.exp >= this.mant.length)
                        ...
                        java.lang.System.arraycopy(res.mant, 0, newmant, 0,
                                newlen);
                        res.mant = newmant;
                        res.form = (byte) ohos.global.icu.math.MathContext.PLAIN;
                        res.exp = 0;
                    }
                }
            }
    ...
    public static ohos.global.icu.math.BigDecimal valueOf(double dub) {
        ...
        return new ohos.global.icu.math.BigDecimal((new java.lang.Double(dub)).toString());
    }
    ...
    public static ohos.global.icu.math.BigDecimal valueOf(long lint) {
    ...
    public static ohos.global.icu.math.BigDecimal valueOf(long lint, int scale) {
        ohos.global.icu.math.BigDecimal res = null;
        {/* select */
            if (lint == 0)
                res = ZERO;
                ...
                res = new ohos.global.icu.math.BigDecimal(lint);
            }
        }
        if (scale == 0)
            return res;
    ...
    private char[] layout() {
        ...
        if (form != ohos.global.icu.math.MathContext.PLAIN) {/* exponential notation needed */
            ...
            if (form == ohos.global.icu.math.MathContext.SCIENTIFIC) { // [default]
    ...
    private ohos.global.icu.math.BigDecimal dodivide(char code, ohos.global.icu.math.BigDecimal rhs,
            ohos.global.icu.math.MathContext set, int scale) {
        ohos.global.icu.math.BigDecimal lhs;
        int reqdig;
        int newexp;
        ohos.global.icu.math.BigDecimal res;
    ...
    private static final ohos.global.icu.math.BigDecimal clone(ohos.global.icu.math.BigDecimal dec) {
        ohos.global.icu.math.BigDecimal copy;
        copy = new ohos.global.icu.math.BigDecimal();
        copy.ind = dec.ind;
        copy.exp = dec.exp;
        copy.form = dec.form;
        copy.mant = dec.mant;
    ...
    private void checkdigits(ohos.global.icu.math.BigDecimal rhs, int dig) {
        if (dig == 0)
    ...
    private ohos.global.icu.math.BigDecimal round(ohos.global.icu.math.MathContext set) {
    ...
    private ohos.global.icu.math.BigDecimal round(int len, int mode) {
        int adjust;
        int sign;
        byte oldmant[];
        boolean reuse = false;
    ...
    private ohos.global.icu.math.BigDecimal finish(ohos.global.icu.math.MathContext set, boolean strip) {
        int d = 0;
        int i = 0;
        byte newmant[] = null;
        int mag = 0;
        ...
        form = (byte) ohos.global.icu.math.MathContext.PLAIN; // preset
                ...
                if (this.mant[i] != 0) {
                    ...
                    if ((mag < MinExp) | (mag > MaxExp)) {
                        overflow: do {
                            ...
                            if (form == ohos.global.icu.math.MathContext.ENGINEERING) {
                                sig = mag % 3; // leftover
                                if (sig < 0)
                                    sig = 3 + sig; // negative exponent
