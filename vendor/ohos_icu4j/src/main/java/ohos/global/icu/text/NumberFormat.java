...
public abstract class NumberFormat extends UFormat {
    ...
    public StringBuffer format(Object number,
        ...
        if (number instanceof Long) {
            ...
            return format((ohos.global.icu.math.BigDecimal) number, toAppendTo, pos);
     ...
     * @see java.text.Format#format(Object, StringBuffer, FieldPosition)
     */
    public abstract StringBuffer format(ohos.global.icu.math.BigDecimal number,
                                        StringBuffer toAppendTo,
                                        FieldPosition pos);
    /**
     ...
     * ohos.global.icu.math.BigDecimal#ROUND_HALF_EVEN ROUND_HALF_EVEN}) for formatting,
    ...
    private static NumberFormatShim getShim() {
        ...
        if (shim == null) {
            try {
                Class<?> cls = Class.forName("ohos.global.icu.text.NumberFormatServiceShim");
