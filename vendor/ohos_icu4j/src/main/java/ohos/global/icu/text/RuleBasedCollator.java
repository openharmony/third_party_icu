...
import ohos.global.icu.impl.Normalizer2Impl.ReorderingBuffer;
...
import ohos.global.icu.impl.coll.CollationKeys.SortKeyByteSink;
 ...
 *
 * <p>A Collator is thread-safe only when frozen. See {{@link #isFrozen()} and {@link ohos.global.icu.util.Freezable}.
 *
 * <p>
...
public final class RuleBasedCollator extends Collator {
    ...
    private final void internalBuildTailoring(String rules) throws Exception {
        ...
        try {
            Class<?> builderClass = classLoader.loadClass("ohos.global.icu.impl.coll.CollationBuilder");
