 ...
 * The {@link ohos.global.icu.text.UnicodeSetIterator UnicodeSetIterator} can also be used, but not in <b>for</b> loops.
 * <p>To replace, count elements, or delete spans, see {@link ohos.global.icu.text.UnicodeSetSpanner UnicodeSetSpanner}.
 *
 * @author Alan Liu
...
public class UnicodeSet extends UnicodeFilter implements Iterable<String>, Comparable<UnicodeSet>, Freezable<UnicodeSet> {
    ...
    /**
     * @see #containsAll(ohos.global.icu.text.UnicodeSet)
     */
    ...
    /**
     * @see #containsNone(ohos.global.icu.text.UnicodeSet)
     */
    ...
    /**
     * @see #addAll(ohos.global.icu.text.UnicodeSet)
     */
    ...
    /**
     * @see #removeAll(ohos.global.icu.text.UnicodeSet)
     */
    ...
    /**
     * @see #retainAll(ohos.global.icu.text.UnicodeSet)
     */
