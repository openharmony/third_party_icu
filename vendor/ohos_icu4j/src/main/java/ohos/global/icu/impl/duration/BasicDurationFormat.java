...
public class BasicDurationFormat extends DurationFormat {
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.DurationFormat#formatDurationFrom(long, long)
     */
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.DurationFormat#formatDurationFromNow(long)
     */
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.DurationFormat#formatDurationFromNowTo(java.util.Date)
     */
