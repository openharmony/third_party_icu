...
import ohos.global.icu.text.CurrencyMetaInfo.CurrencyDigits;
import ohos.global.icu.text.CurrencyMetaInfo.CurrencyFilter;
...
public class Currency extends MeasureUnit {
    ...
    private static ServiceShim getShim() {
        ...
        if (shim == null) {
            try {
                Class<?> cls = Class.forName("ohos.global.icu.util.CurrencyServiceShim");
