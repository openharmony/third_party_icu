...
public final class VersionInfo implements Comparable<VersionInfo>
{
     ...
     * Should be the same as {@link ohos.global.icu.lang.UCharacter#getUnicodeVersion()}
    ...
    static String getTZDataVersion() {
        if (TZDATA_VERSION == null) {
            synchronized (VersionInfo.class) {
                if (TZDATA_VERSION == null) {
                    UResourceBundle tzbundle = UResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt"
