...
public class RelativeDateFormat extends DateFormat {
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.DateFormat#format(ohos.global.icu.util.Calendar, java.lang.StringBuffer, java.text.FieldPosition)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.DateFormat#parse(java.lang.String, ohos.global.icu.util.Calendar, java.text.ParsePosition)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ohos.global.icu.text.DateFormat#setContext(ohos.global.icu.text.DisplayContext)
