 ...
 * inner static interface ohos.global.icu.impl.Trie.DataManipulate.</p>
 ...
 * in the data.</p>
 * <p>Methods in ohos.global.icu.impl.Trie.DataManipulate are called to retrieve
 * that offset from the folded value for the lead surrogate unit.</p>
 * <p>For examples of use, see ohos.global.icu.impl.CharTrie or
 * ohos.global.icu.impl.IntTrie.</p>
 * @author synwee
 * @see ohos.global.icu.impl.CharTrie
 * @see ohos.global.icu.impl.IntTrie
...
public abstract class Trie
{
    ...
    */
    ...
    {
        /**
        * Called by ohos.global.icu.impl.Trie to extract from a lead surrogate's
        * data
