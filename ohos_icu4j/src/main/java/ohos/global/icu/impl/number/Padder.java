...
public class Padder {
    ...
    public enum PadPosition {
        ...
        public static PadPosition fromOld(int old) {
            switch (old) {
            case ohos.global.icu.text.DecimalFormat.PAD_BEFORE_PREFIX:
                return PadPosition.BEFORE_PREFIX;
            case ohos.global.icu.text.DecimalFormat.PAD_AFTER_PREFIX:
                return PadPosition.AFTER_PREFIX;
            case ohos.global.icu.text.DecimalFormat.PAD_BEFORE_SUFFIX:
                return PadPosition.BEFORE_SUFFIX;
            case ohos.global.icu.text.DecimalFormat.PAD_AFTER_SUFFIX:
        ...
        public int toOld() {
            switch (this) {
            case BEFORE_PREFIX:
                return ohos.global.icu.text.DecimalFormat.PAD_BEFORE_PREFIX;
            case AFTER_PREFIX:
                return ohos.global.icu.text.DecimalFormat.PAD_AFTER_PREFIX;
            case BEFORE_SUFFIX:
                return ohos.global.icu.text.DecimalFormat.PAD_BEFORE_SUFFIX;
            case AFTER_SUFFIX:
                return ohos.global.icu.text.DecimalFormat.PAD_AFTER_SUFFIX;
            default:
