...
public final class UTF16 {
     ...
     * {@link ohos.global.icu.lang.UCharacter#isLegal(int)} on char32 before calling.
     *
     * @param char32 The input character.
     ...
     * required, use {@link ohos.global.icu.lang.UCharacter#isLegal(int)} on the
     ...
     * is required, use {@link ohos.global.icu.lang.UCharacter#isLegal(int)} on
     ...
     * {@link ohos.global.icu.lang.UCharacter#isLegal(int)} on the codepoint at
     ...
     * use {@link ohos.global.icu.lang.UCharacter#isLegal(int)} on char32 before
     * calling.
     *
    ...
    public static final class StringComparator implements java.util.Comparator<String> {
         ...
         * Unicode data file CaseFolding.txt, before comparison.
         *
         * @see ohos.global.icu.lang.UCharacter#FOLD_CASE_EXCLUDE_SPECIAL_I
         */
