...
public class RuleBasedNumberFormat extends NumberFormat {
     ...
     * Implement ohos.global.icu.text.NumberFormat:
     * Format a BigInteger.
     */
    @Override
    public StringBuffer format(BigInteger number,
                               StringBuffer toAppendTo,
                               FieldPosition pos) {
        return format(new ohos.global.icu.math.BigDecimal(number), toAppendTo, pos);
    }
    ...
    private static final ohos.global.icu.math.BigDecimal MAX_VALUE = ohos.global.icu.math.BigDecimal.valueOf(Long.MAX_VALUE);
    private static final ohos.global.icu.math.BigDecimal MIN_VALUE = ohos.global.icu.math.BigDecimal.valueOf(Long.MIN_VALUE);
     ...
     */
    @Override
    public StringBuffer format(ohos.global.icu.math.BigDecimal number,
                               StringBuffer toAppendTo,
                               FieldPosition pos) {
    ...
    public RbnfLenientScannerProvider getLenientScannerProvider() {
        ...
        if (scannerProvider == null && lenientParse && !lookedForScanner) {
            try {
                ...
                Class<?> cls = Class.forName("ohos.global.icu.impl.text.RbnfScannerProviderImpl");
