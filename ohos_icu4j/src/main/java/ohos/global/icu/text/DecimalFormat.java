...
import ohos.global.icu.impl.number.DecimalFormatProperties.ParseMode;
...
import ohos.global.icu.impl.number.Padder.PadPosition;
...
import ohos.global.icu.util.ULocale.Category;
 ...
 * from using DecimalFormat.  For more information, see the package ohos.global.icu.number.
 *
 * <h3>Example Usage</h3>
 *
 ...
 *
 * <pre>
 * ohos.global.icu.impl.number.Parse.DEBUGGING = true;
 * df.parse("123.45", ppos);
 * ohos.global.icu.impl.number.Parse.DEBUGGING = false;
 * </pre>
 *
...
public class DecimalFormat extends NumberFormat {
  ...
  private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
    ...
    if (serialVersion > 5) {
      throw new IOException(
          "Cannot deserialize newer ohos.global.icu.text.DecimalFormat (v" + serialVersion + ")");
      ...
      if (serializedProperties instanceof DecimalFormatProperties) {
        ...
        // ICU 59
        properties = ((ohos.global.icu.impl.number.Properties) serializedProperties).getInstance();
      }
      // 2) DecimalFormatSymbols
  ...
  public Number parse(String text, ParsePosition parsePosition) {
      ...
      if (result.success()) {
          ...
          // Backwards compatibility: return ohos.global.icu.math.BigDecimal
  ...
  /**
   * <strong>[icu]</strong> Returns the {@link ohos.global.icu.math.MathContext} being used to round numbers.
   *
   * @see #setMathContext
   */
   ...
   * {@link ohos.global.icu.math.MathContext}.
   *
  ...
  /**
   * Whether to make {@link #parse} prefer returning a {@link ohos.global.icu.math.BigDecimal} when
 ...
 * @hide draft / provisional / internal are hidden on OHOS
  ...
  /**
   * Converts a java.math.BigDecimal to a ohos.global.icu.math.BigDecimal with fallback for numbers
   * outside of the range supported by ohos.global.icu.math.BigDecimal.
   *
   * @param number
   * @return
   */
  private Number safeConvertBigDecimal(java.math.BigDecimal number) {
    try {
      return new ohos.global.icu.math.BigDecimal(number);
