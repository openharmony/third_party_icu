...
import ohos.global.icu.impl.UCharacterNameChoice;
...
import ohos.global.icu.lang.UCharacterEnums.ECharacterDirection;
 ...
 * <i>$ICU4J_SRC/src/ohos.global.icu.impl.data</i> to your class directory
 * <i>$ICU4J_CLASS/ohos.global.icu.impl.data</i>.
 *
 ...
 *        ohos.global.icu.dev.test.lang.UCharacterCompare</a>
 * <p>
 ...
 *
 * @author Syn Wee Quek
 * @see ohos.global.icu.lang.UCharacterEnums
 */
...
public final class UCharacter implements ECharacterCategory, ECharacterDirection
{
     ...
     * and a {@link ohos.global.icu.text.NumberFormat} can be used with
     * a Chinese {@link ohos.global.icu.text.NumberingSystem}.
     *
     * @param ch code point to query
     ...
     * @param property selector constant from ohos.global.icu.lang.UProperty,
     ...
     * @see ohos.global.icu.lang.UProperty
     ...
     * to allocate arrays of ohos.global.icu.text.UnicodeSet or similar.
     * @param type UProperty selector constant, identifies which binary
     *        property to check. Must be
     *        UProperty.BINARY_START &lt;= type &lt; UProperty.BINARY_LIMIT or
