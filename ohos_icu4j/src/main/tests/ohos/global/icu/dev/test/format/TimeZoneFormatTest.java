...
import ohos.global.icu.text.TimeZoneFormat.GMTOffsetPatternType;
...
public class TimeZoneFormatTest extends TestFmwk {
    ...
    public void TestDefaultTimeZoneNames() {
        ...
        try {
            Class cls = Class.forName("ohos.global.icu.text.TimeZoneNames$DefaultTimeZoneNames$FactoryImpl");
