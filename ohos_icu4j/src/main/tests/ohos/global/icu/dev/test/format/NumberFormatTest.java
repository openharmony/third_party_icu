...
package ohos.global.icu.dev.test.format;
...
import ohos.global.icu.dev.test.format.IntlTestDecimalFormatAPIC.FieldContainer;
...
import ohos.global.icu.impl.data.ResourceReader;
import ohos.global.icu.impl.data.TokenIterator;
...
import ohos.global.icu.text.NumberFormat.NumberFormatFactory;
import ohos.global.icu.text.NumberFormat.SimpleNumberFormatFactory;
import ohos.global.icu.text.NumberingSystem;
import ohos.global.icu.text.RuleBasedNumberFormat;
import ohos.global.icu.text.UnicodeSet;
import ohos.global.icu.util.Currency;
import ohos.global.icu.util.Currency.CurrencyUsage;
...
public class NumberFormatTest extends TestFmwk {
    ...
    public void TestFieldPositionDecimal() {
        DecimalFormat nf = (DecimalFormat) ohos.global.icu.text.NumberFormat.getInstance(ULocale.ENGLISH);
    ...
    public void TestFieldPositionCurrency() {
        DecimalFormat nf = (DecimalFormat) ohos.global.icu.text.NumberFormat.getCurrencyInstance(Locale.US);
        double amount = 35.47;
        ...
        nf = (DecimalFormat) ohos.global.icu.text.NumberFormat.getCurrencyInstance(Locale.FRANCE);
        ...
        nf = (DecimalFormat) ohos.global.icu.text.NumberFormat.getCurrencyInstance(Locale.JAPAN);
        ...
        nf = (DecimalFormat) ohos.global.icu.text.NumberFormat.getCurrencyInstance(new Locale("ar", "eg"));
    ...
    public void TestRoundingPattern() {
        ...
        DecimalFormat df = (DecimalFormat) ohos.global.icu.text.NumberFormat.getInstance(ULocale.ENGLISH);
        String result;
    ...
    public void TestFormat() {
        ...
        // Tests when "else if (number instanceof ohos.global.icu.math.BigDecimal)" is true
        try {
            nf.format((Object)new ohos.global.icu.math.BigDecimal("0"), sb, fp);
        } catch (Exception e) {
            errln("NumberFormat.format(Object number, ...) was not suppose to "
                    + "return an exception for a ohos.global.icu.math.BigDecimal object. Error: " + e);
        }
    ...
    public void TestLenientSymbolParsing() {
        ...
        String skipExtSepParse = ICUConfig.get("ohos.global.icu.text.DecimalFormat.SkipExtendedSeparatorParsing", "false");
    ...
    */
    ...
    public void TestSetMaxFracAndRoundIncr() {
        ...
        for (SetMxFrAndRndIncrItem item: items) {
            ...
            java.math.BigDecimal bigdec = df.getRoundingIncrement(); // why doesn't this return ohos.global.icu.math.BigDecimal?
   ...
   // Testing for Issue 11805.
    ...
    public void testRoundingModeSetters() {
        ...
        df2.setRoundingMode(ohos.global.icu.math.BigDecimal.ROUND_CEILING);
    ...
    public void testParseVeryVeryLargeExponent() {
        ...
        Object[][] cases = {
                ...
                {"1.2E+999999999", new ohos.global.icu.math.BigDecimal("1.2E+999999999")},
