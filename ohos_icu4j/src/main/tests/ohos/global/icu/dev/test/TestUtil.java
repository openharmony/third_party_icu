...
import ohos.global.icu.ResourceHelper;
...
public final class TestUtil {
     ...
     */
    public static final String DATA_PATH = "/ohos/global/icu/dev/data/";
    ...
    public static final BufferedReader getDataReader(String name, String charset) throws IOException {
        InputStream is = ResourceHelper.getResourceStream("ohos/global/icu/dev/data/" +  name);
