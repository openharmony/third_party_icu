...
package ohos.global.icu.dev.test.normalizer;
...
import ohos.global.icu.text.FilteredNormalizer2;
    ...
    */
    ...
    public void TestCustomComp() {
        ...
        customNorm2=
            Normalizer2.getInstance(
                BasicTest.class.getResourceAsStream("/ohos/global/icu/dev/data/testdata/testnorm.nrm"),
                "testnorm",
    ...
    public void TestNormalizeIllFormedText() {
        ...
        String src = "  A\uD800ÄA\u0308\uD900A\u0308\u00ad\u0323\uDBFFÄ\u0323," +
                "\u00ad\uDC00\u1100\u1161가\u11A8가\u3133  \uDFFF";
        String expected = "  a\uD800ää\uD900ạ\u0308\uDBFFạ\u0308,\uDC00가객갃  \uDFFF";
