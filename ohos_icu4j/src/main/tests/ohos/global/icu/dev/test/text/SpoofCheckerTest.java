 ...
 *******************************************************************************
 */
package ohos.global.icu.dev.test.text;
...
import ohos.global.icu.text.SpoofChecker;
import ohos.global.icu.text.SpoofChecker.CheckResult;
import ohos.global.icu.text.SpoofChecker.RestrictionLevel;
...
public class SpoofCheckerTest extends TestFmwk {
    ...
    public void testScriptSet() {
        try {
            Class ScriptSet = Class.forName("ohos.global.icu.text.SpoofChecker$ScriptSet");
