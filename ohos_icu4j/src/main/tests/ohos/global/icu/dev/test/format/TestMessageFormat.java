...
public class TestMessageFormat extends TestFmwk {
    ...
    */
    ...
    public void TestSetGetFormats()
    {
        ...
        assertEquals("1st subformmater: Format Class", "ohos.global.icu.text.DecimalFormat", fmts2[0].getClass().getName());
        assertEquals("1st subformmater: its Locale", ULocale.GERMAN, ((UFormat)fmts2[0]).getLocale(ULocale.VALID_LOCALE));
        assertEquals("2nd subformatter: Format Class", "ohos.global.icu.text.SimpleDateFormat", fmts2[1].getClass().getName());
