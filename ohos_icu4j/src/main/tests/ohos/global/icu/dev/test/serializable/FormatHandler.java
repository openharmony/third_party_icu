...
import ohos.global.icu.impl.TimeZoneGenericNames.GenericNameType;
...
import ohos.global.icu.text.SelectFormat;
import ohos.global.icu.text.SimpleDateFormat;
import ohos.global.icu.text.TimeUnitFormat;
import ohos.global.icu.text.TimeZoneFormat;
import ohos.global.icu.text.TimeZoneFormat.Style;
...
//                System.out.println("\n    " + uloc.toString() + " = \"" +
//                        ohos.global.icu.impl.Utility.escape(String.valueOf(getCharSymbols(dfs[i]), 0, 12)) + "\"");
            }
